...
I am a Reader of Robotics and Autonomous Systems at the School of Engineering, Cardiff University, and the Group Leader of Robotics and Autonomous Intelligent Machines (RAIM). I am also the recipient of the Royal Academy of Engineering Industrial Fellowship, hosted by Spirent Communications. I am the co-founder/co-investigator of the IROHMS (Research Centre for AI, Robotics and Human Machine Systems) funded by ERDF through WEFO. 

I am managing the Robotics and Autonomous Systems laboratory, which provides cutting-edge robotic facilities, including two Kuka Lbr iiwa robots, three Kuka youbots, Unitree robot dogs, Robotnik Vogui+, some turtlebots, and some advanced vision systems (Zivid, Roboception, RealSense etc). We have also built two USVs (unmanned surface vehicles) with student projects in the past years. See the page Facilities for details about the robots.

I currently serve as an associate editor for

- IEEE/ASME Transactions on Mechatronics
- Proceedings of the Institution of Mechanical Engineers, Part C: Journal of Mechanical Engineering Science (Robotics section)
- Industrial Robot 
- International Journal on Interactive Design and Manufacturing (IJDM)
- IEEE Access
